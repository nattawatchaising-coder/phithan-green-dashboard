...
function DailyReport({
  ...
  React.useEffect(() => {
    populate(entries[date]);
  }, [date]);
  React.useEffect(() => {
    if (!dirty.current) populate(entries[date]);
  }, [entries]);
  const set = (k, v) => {
    dirty.current = true;
    setSaved(false);
  ...
  if (job.battery && job.batSize && job.batSize !== "ไม่มี") specChips.push({
    icon: "battery",
    t: job.batSize
  });
  if (job.backup) specChips.push({
    icon: "shield",
    t: "Back Up"
  });
  return React.createElement("div", {
  ...
  }, "\u0E23\u0E32\u0E22\u0E07\u0E32\u0E19\u0E1B\u0E23\u0E30\u0E08\u0E33\u0E27\u0E31\u0E19 \xB7 \u0E15\u0E34\u0E14\u0E15\u0E31\u0E49\u0E07"), React.createElement("div", {
    style: {
      fontSize: 16,
      fontWeight: 800,
      color: "var(--text-1)",
  ...
  }, "\xB7 ", job.code))), React.createElement("button", {
    onClick: onClose,
    title: "\u0E1B\u0E34\u0E14",
    style: {
      width: 34,
    ...
    size: 14,
    color: "var(--primary)"
  }), " \u0E27\u0E31\u0E19\u0E17\u0E35\u0E48\u0E23\u0E32\u0E22\u0E07\u0E32\u0E19"), React.createElement("input", {
    type: "date",
    value: date,
    max: today,
  ...
  }), entries[date] && React.createElement("span", {
    style: {
      fontSize: 11,
      fontWeight: 700,
      color: "var(--primary-dark)",
  ...
  }, "\u0E21\u0E35\u0E1A\u0E31\u0E19\u0E17\u0E36\u0E01\u0E41\u0E25\u0E49\u0E27"), savedDates.length > 0 && React.createElement("span", {
    style: {
      fontSize: 11,
      color: "var(--text-3)"
    }
  }, "\u0E1A\u0E31\u0E19\u0E17\u0E36\u0E01\u0E44\u0E27\u0E49 ", savedDates.length, " \u0E27\u0E31\u0E19")), React.createElement("div", {
    style: {
      border: "1px solid var(--border)",
      borderRadius: 12,
      padding: 13,
  ...
  }, job.brand)), React.createElement("div", {
    style: {
      display: "flex",
      gap: 6,
      flexWrap: "wrap",
  ...
  }, specChips.map((c, i) => React.createElement("span", {
    key: i,
    style: {
      display: "inline-flex",
      alignItems: "center",
  ...
  }), " \u0E0A\u0E48\u0E27\u0E07\u0E15\u0E34\u0E14\u0E15\u0E31\u0E49\u0E07: ", React.createElement("b", {
    style: {
      color: "var(--text-2)"
    }
  }, rpDateRange(job.startDate, job.deadline))), tech && React.createElement("span", null, React.createElement(Icon, {
    name: "user",
    size: 11,
    color: "var(--text-3)",
    style: {
  ...
  }), " \u0E0A\u0E48\u0E32\u0E07: ", React.createElement("b", {
    style: {
      color: "var(--text-2)"
    }
  }, tech.name)), React.createElement("span", null, React.createElement(Icon, {
    name: "box",
    size: 11,
    color: "var(--text-3)",
    style: {
  ...
  }), " \u0E27\u0E31\u0E2A\u0E14\u0E38\u0E1E\u0E23\u0E49\u0E2D\u0E21: ", React.createElement("b", {
    style: {
      color: "var(--text-2)"
    }
    ...
    style: lbl
  }, "\u0E04\u0E27\u0E32\u0E21\u0E04\u0E37\u0E1A\u0E2B\u0E19\u0E49\u0E32 (%)"), React.createElement("input", {
    type: "number",
    min: "0",
    max: "100",
    value: form.pct,
    ...
    style: lbl
  }, "\u0E17\u0E35\u0E21\u0E0A\u0E48\u0E32\u0E07\u0E27\u0E31\u0E19\u0E19\u0E35\u0E49"), React.createElement("input", {
    value: form.crew,
    onChange: e => set("crew", e.target.value),
    placeholder: tech ? tech.name : "ชื่อทีม/ช่าง",
    style: {
      width: "100%",
      padding: "9px 11px",
      borderRadius: 10,
    ...
    style: lbl
  }, "\u2705 \u0E07\u0E32\u0E19\u0E17\u0E35\u0E48\u0E17\u0E33\u0E27\u0E31\u0E19\u0E19\u0E35\u0E49 (\u0E1A\u0E23\u0E23\u0E17\u0E31\u0E14\u0E25\u0E30 1 \u0E23\u0E32\u0E22\u0E01\u0E32\u0E23)"), React.createElement("textarea", {
    value: form.done,
    ...
    style: lbl
  }, "\u26A0\uFE0F \u0E1B\u0E31\u0E0D\u0E2B\u0E32 / \u0E2D\u0E38\u0E1B\u0E2A\u0E23\u0E23\u0E04"), React.createElement("textarea", {
    value: form.issues,
    onChange: e => set("issues", e.target.value),
    placeholder: "\u0E40\u0E0A\u0E48\u0E19 \u0E1D\u0E19\u0E15\u0E01\u0E0A\u0E48\u0E27\u0E07\u0E1A\u0E48\u0E32\u0E22 \u0E2B\u0E22\u0E38\u0E14\u0E07\u0E32\u0E19 1 \u0E0A\u0E21.",
    style: Object.assign({}, taStyle, {
      minHeight: 48
    })
  })), React.createElement("div", null, React.createElement("label", {
    style: lbl
  }, "\u27A1\uFE0F \u0E41\u0E1C\u0E19\u0E07\u0E32\u0E19\u0E1E\u0E23\u0E38\u0E48\u0E07\u0E19\u0E35\u0E49"), React.createElement("textarea", {
    value: form.plan,
    onChange: e => set("plan", e.target.value),
    placeholder: "\u0E40\u0E0A\u0E48\u0E19 \u0E15\u0E48\u0E2D Combiner + \u0E17\u0E14\u0E2A\u0E2D\u0E1A\u0E23\u0E30\u0E1A\u0E1A",
    style: Object.assign({}, taStyle, {
      minHeight: 48
    })
  ...
  }, "\u0E15\u0E31\u0E27\u0E2D\u0E22\u0E48\u0E32\u0E07\u0E23\u0E32\u0E22\u0E07\u0E32\u0E19"), React.createElement("div", {
    style: {
      border: "1px solid var(--border)",
      borderRadius: 14,
      overflow: "hidden",
  ...
  }, "PHITHAN GREEN \xB7 \u0E23\u0E32\u0E22\u0E07\u0E32\u0E19\u0E15\u0E34\u0E14\u0E15\u0E31\u0E49\u0E07"), React.createElement("div", {
    style: {
      fontSize: 15,
      fontWeight: 800,
      marginTop: 2
    }
  }, thDate(date, true))), React.createElement("div", {
    style: {
      padding: "14px 16px",
      display: "flex",
      flexDirection: "column",
  ...
  }, "\xB7 ", job.code)), pct != null && React.createElement("div", null, React.createElement("div", {
    style: {
      display: "flex",
      justifyContent: "space-between",
      fontSize: 12,
  ...
  }, React.createElement("span", null, "\u0E04\u0E27\u0E32\u0E21\u0E04\u0E37\u0E1A\u0E2B\u0E19\u0E49\u0E32"), React.createElement("span", {
    style: {
      color: "var(--primary-dark)"
    }
  ...
  }, React.createElement("span", null, "\uD83D\uDC77 ", (form.crew || "").trim() || (tech ? tech.name : "-")), React.createElement("span", null, "\uD83D\uDCE6 \u0E27\u0E31\u0E2A\u0E14\u0E38\u0E1E\u0E23\u0E49\u0E2D\u0E21 ", job.matReadyPct, "%")))))), React.createElement("div", {
    style: {
      padding: 14,
      borderTop: "1px solid var(--border)",
      display: "flex",
    ...
    style: {
      padding: "11px 16px",
      borderRadius: 11,
      border: "1px solid " + (saved ? "var(--primary)" : "var(--border-strong)"),
      background: saved ? "var(--primary-soft)" : "var(--surface2)",
      color: saved ? "var(--primary-dark)" : "var(--text-2)",
      fontWeight: 700,
      fontFamily: "inherit",
      fontSize: 13.5,
      cursor: "pointer",
    ...
    size: 15,
    color: saved ? "var(--primary-dark)" : "var(--text-2)"
  }), " ", saved ? "บันทึกแล้ว" : "บันทึก"), React.createElement("button", {
    onClick: copy,
    style: {
      flex: 1,
      padding: "11px 16px",
...
function DRBlock({
  ...
  }, emoji, " ", title), React.createElement("ul", {
    style: {
      listStyle: "none",
      margin: 0,
      padding: 0,
  ...
  }, lines.map((x, i) => React.createElement("li", {
    key: i,
    style: {
      display: "flex",
      gap: 7,
...
function DailyReportButton({
  ...
  return React.createElement(React.Fragment, null, React.createElement("button", {
    ...
    size: 13,
    color: "var(--primary-dark)"
  }), " \u0E23\u0E32\u0E22\u0E07\u0E32\u0E19\u0E27\u0E31\u0E19\u0E19\u0E35\u0E49"), open && ReactDOM.createPortal(React.createElement(DailyReport, {
    job: job,
