...
(function () {
  ...
  /* ประเภทงาน — Tesla แยกจากงานบ้านทั่วไป เพราะรายงานประจำวัน/สัปดาห์/เดือนต้องสรุปแยกกัน
     (เพิ่มที่นี่ที่เดียว: ป้าย · ฟอร์มใบงาน · ตัวกรองหัวหน้า · หน้าสรุปรายงาน อ่านจากตารางนี้ทั้งหมด)
     สี Tesla ตั้งใจไม่ใช้แดงเดียวกับป้าย "ล่าช้า" จะได้ไม่ดูเหมือนงานติดปัญหาทุกใบ */
  const TYPES = [
    { key: "home",    th: "งานบ้าน",     color: "#F59E0B" },
    { key: "tesla",   th: "Tesla",       color: "#DB2777" },
