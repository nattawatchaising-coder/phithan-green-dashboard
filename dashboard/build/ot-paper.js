...
function tmOtByPerson(rows, users) {
  ...
  (rows || []).forEach(r => {
    ...
    const m = +r.mins || 0;
    g.mins += m;
    if (r.status === "approved") g.minsApproved += m;else if (r.status === "draft" || r.status === "sent") g.minsWaiting += m;
  });
...
function TmOtPaper({
  ...
  const sum = React.useMemo(() => {
    ...
    list.forEach(o => {
      const m = +o.mins || 0;
      if (o.status === "approved") approved += m;else if (o.status === "rejected" || o.status === "cancelled") rejected += m;else waiting += m;
    });
    return {
      approved: approved,
      waiting: waiting,
  ...
  }, "\u0E0A\u0E31\u0E48\u0E27\u0E42\u0E21\u0E07 (", window.tmDur(sum.approved), ")")), React.createElement("tr", null, React.createElement("td", {
    colSpan: 4,
    style: Object.assign({}, td, {
      textAlign: "right",
      fontWeight: 700,
  ...
  }, "\u0E40\u0E27\u0E25\u0E32\u0E43\u0E19\u0E43\u0E1A\u0E19\u0E35\u0E49\u0E40\u0E1B\u0E47\u0E19\u0E40\u0E27\u0E25\u0E32\u0E17\u0E35\u0E48\u0E1C\u0E39\u0E49\u0E02\u0E2D\u0E01\u0E23\u0E2D\u0E01\u0E40\u0E2D\u0E07 \u0E44\u0E21\u0E48\u0E43\u0E0A\u0E48\u0E40\u0E27\u0E25\u0E32\u0E17\u0E35\u0E48\u0E23\u0E30\u0E1A\u0E1A\u0E08\u0E31\u0E1A\u0E44\u0E14\u0E49 \u2014 \u0E16\u0E49\u0E32\u0E44\u0E21\u0E48\u0E41\u0E19\u0E48\u0E43\u0E08\u0E43\u0E2B\u0E49\u0E40\u0E17\u0E35\u0E22\u0E1A\u0E01\u0E31\u0E1A\u0E41\u0E1C\u0E48\u0E19 \u201C\u0E40\u0E27\u0E25\u0E32\u0E17\u0E33\u0E07\u0E32\u0E19\u201D \u0E02\u0E2D\u0E07\u0E27\u0E31\u0E19\u0E19\u0E31\u0E49\u0E19", React.createElement("br", null), "\u0E01\u0E32\u0E23\u0E40\u0E0B\u0E47\u0E19\u0E1A\u0E19\u0E01\u0E23\u0E30\u0E14\u0E32\u0E29\u0E44\u0E21\u0E48\u0E44\u0E14\u0E49\u0E40\u0E1B\u0E25\u0E35\u0E48\u0E22\u0E19\u0E2A\u0E16\u0E32\u0E19\u0E30\u0E43\u0E19\u0E23\u0E30\u0E1A\u0E1A \u0E43\u0E1A\u0E17\u0E35\u0E48\u0E22\u0E31\u0E07\u0E23\u0E2D\u0E2D\u0E19\u0E38\u0E21\u0E31\u0E15\u0E34\u0E15\u0E49\u0E2D\u0E07\u0E01\u0E14\u0E2D\u0E19\u0E38\u0E21\u0E31\u0E15\u0E34\u0E43\u0E19\u0E23\u0E30\u0E1A\u0E1A\u0E14\u0E49\u0E27\u0E22", React.createElement("br", null), "\u0E43\u0E1A\u0E19\u0E35\u0E49\u0E2A\u0E23\u0E38\u0E1B\u0E40\u0E09\u0E1E\u0E32\u0E30\u0E0A\u0E31\u0E48\u0E27\u0E42\u0E21\u0E07 \u0E44\u0E21\u0E48\u0E44\u0E14\u0E49\u0E04\u0E34\u0E14\u0E04\u0E48\u0E32\u0E15\u0E2D\u0E1A\u0E41\u0E17\u0E19 \u0E40\u0E1E\u0E23\u0E32\u0E30\u0E2D\u0E31\u0E15\u0E23\u0E32\u0E04\u0E48\u0E32\u0E41\u0E23\u0E07\u0E23\u0E32\u0E22\u0E04\u0E19\u0E44\u0E21\u0E48\u0E44\u0E14\u0E49\u0E2D\u0E22\u0E39\u0E48\u0E43\u0E19\u0E23\u0E30\u0E1A\u0E1A\u0E19\u0E35\u0E49"), React.createElement("div", {
    style: {
      marginTop: 12,
      fontSize: 9.5,
      color: "#8A9A91",
