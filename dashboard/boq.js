...
(function () {
  ...
  const WIRE_METHODS = [
    ...
    { key: "wireway", th: "ราง · รางเดินสายปิดมีฝา (Wireway)", art: "way", group: "g2", groups: ["g2"],
      base: "conduitAir", baseWhy: "Wireway เป็นช่องเดินสายปิด ระบายความร้อนแบบเดียวกับเดินในท่อ จึงใช้ตารางเดียวกัน" },
