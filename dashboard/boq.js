...
(function () {
  ...
  const WIRE_METHODS = [
    ...
    { key: "conduitAir", th: "เดินในท่อโลหะหรืออโลหะ", art: "g2", group: "g2", groups: ["g2", "g1", "g5"],
      sub: "ในฝ้าเพดานที่เป็นฉนวนความร้อน/ผนังกันไฟ · เกาะผนังหรือฝังในผนังคอนกรีต · ฝังดิน (กลุ่มที่ 1, 2, 5)" },
    // ── เดินลอย / เกาะโครงสร้าง ──
    { key: "surface", th: "เดินเกาะผนังหรือเพดานโดยตรง", art: "g3", group: "g3", groups: ["g3"],
      sub: "ไม่มีสิ่งปิดหุ้ม (กลุ่มที่ 3)" },
    { key: "insulator", th: "เดินบนฉนวนลูกถ้วยในอากาศ", art: "g4", group: "g4", groups: ["g4"],
      sub: "ใช้สายแกนเดียว แยกตารางตามการวางแนวตั้ง/แนวราบ (กลุ่มที่ 4)" },
    { key: "buried", th: "เดินฝังดินโดยตรง", art: "g6", group: "g6", groups: ["g6"],
    ...
    { key: "traySolid", th: "เดินรางเคเบิลแบบด้านล่างทึบ — เปิดฝา", art: "traySolid", group: "g7", groups: ["g7"],
      sub: "กลุ่มที่ 7 · พื้นรางเป็นแผ่นทึบ ลมออกได้ทางด้านบนอย่างเดียว" },
    { key: "trayPerf", th: "เดินรางเคเบิลแบบระบายอากาศ — เปิดฝา", art: "trayVent", group: "g7", groups: ["g7"],
      sub: "กลุ่มที่ 7 · พื้นรางเจาะรู ลมผ่านได้ทั้งด้านบนและใต้ราง" },
    { key: "ladder", th: "เดินรางเคเบิลแบบบันได — เปิดฝา", art: "ladder", group: "g7", groups: ["g7"],
      sub: "กลุ่มที่ 7 · พื้นเป็นขั้นบันได โปร่งที่สุดในบรรดาราง" },
    { key: "trayCover", th: "เดินรางเคเบิลแบบปิดฝา", art: "trayCover", group: "g7", groups: ["g7"],
