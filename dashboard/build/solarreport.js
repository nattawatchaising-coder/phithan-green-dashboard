...
const RP_I18N = {
  ...
  "สมมติฐาน: ค่าไฟ {} ปรับขึ้นปีละ {} · ใช้ไฟเอง {} ส่วนที่เหลือ ขายคืนหน่วยละ {} · ค่าดูแลรักษาปีละ {} ของค่าติดตั้ง · อัตราคิดลด {}": ["Assumptions: tariff {} rising {} per year · self-consumption {}, the remainder exported at {} per unit · O&M {} of installed cost per year · discount rate {}", "假设条件：电价 {}，每年上涨 {} · 自用比例 {}，其余按每度 {} 上网 · 运维费为安装成本的 {}/年 · 折现率 {}"],
