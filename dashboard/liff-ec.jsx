...
function LnEcTab({ me, users, role, jobs }) {
  ...
  /* เห็นเฉพาะใบของตัวเองบนมือถือเสมอ แม้คนนั้นจะมีสิทธิ์อนุมัติ —
     การอนุมัติต้องดูบิลเทียบยอดบนจอใหญ่ หน้านี้ไม่ได้ทำมาเพื่อการนั้น */
  ...
  return (
    <div style={{ padding: 18 }}>
      ...
      <div style={{ marginTop: 12, fontSize: 11, color: "var(--text-3)", lineHeight: 1.7, textAlign: "center" }}>
        การอนุมัติและการจ่ายเงินคืนทำที่หน้าเว็บบนคอมพิวเตอร์
